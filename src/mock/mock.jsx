...
import icon2 from "../assets/icons/bag.png";
import icon3 from "../assets/icons/coin.png";
import icon4 from "../assets/icons/shazam.png";
import icon5 from "../assets/icons/gif.png";
import icon6 from "../assets/icons/silver.png";
import icon7 from "../assets/icons/file.png";
import icon8 from "../assets/icons/monitor.png";
import icon9 from "../assets/icons/mikrophone.png";
import icon10 from "../assets/icons/sertificat.png";
...
export const why = [
  {
    id: 1,
    icon: icon,
    title: "Mablag'ingiz yo'qmi?-yechimi bor!",
  ...
  },
  {
    id: 2,
    icon: icon2,
    title: "Ish joyini 100% kafolatlaymiz!",
    desc: "Bizning kurslarimizni muvaffaqiyatli tamomlagan o'quvchilarimiz 100% ish bilan ta'minlanishiga ishonasizmi? Ha albatta, biz Sizga ish joyini 100% kafolatlaymiz!",
  },
  {
    id: 3,
    icon: icon3,
  ...
  },
  {
    ...
    desc: "Sun'iy intellekt shiddat bilan rivojlanayotgan hozirgi vaqtda, kasbingizda uni samarali qo'llashni o'rgatamiz. Ortda qolmang!",
  },
  {
    id: 5,
    icon: icon5,
    title: "Eng so'ngi o'quv dasturlari Siz uchun!",
    desc: "Biznig o'quv dasturlarimiz eng so'ngi ma'lumotlar va texnologiyalarga asoslangan holda doimo yangilanib boradi. Bu esa o'z o'rnida Sizning sifatli ta'lim olishingizni ta'minlab beradi!",
  },
  {
    id: 6,
    icon: icon6,
    title: "Kuchli mutaxassislardan sifatli ta'lim oling!",
    desc: "Bizning barcha Mentorlarimiz kamida 3 yil tajribaga ega va ko'plab loyihalar muallifi bo'lgan mutaxassislardir. Biznig o'quv dasturlarimiz ular ishtirokida shakillantiriladi. Bu hammasi Sizning sifatli ta'lim olishingiz uchun!",
  },
  {
    id: 7,
    icon: icon7,
    title: "Amaliyot, real loyihalar va portfolio!",
    desc: "Bizning kursimiz davomida o'quvchilar real loyihalarni tamomlab mijozga taqdim etishadi. Bundan yaxshiroq amaliyot bo'lmasa kerak! Va bu portfolio uchun juda foydali!",
  },
  {
    id: 8,
    icon: icon8,
    title: "Zamonaviy muhit, bepul Coworking va Wi-fi",
    desc: "Aipply Academy o'quv markazi zamon talabiga javob beradigan barcha imkoniyatlar va texnologiyalar bilan jihozlangan. Bularning barchasi bizning o'quvchilarimiz uchun bepul!",
  },
  {
    id: 9,
    icon: icon9,
    title: "Bepul mahorat darslari va musobaqalar",
    desc: "Aipply Academy o'quv markazida muntazam ravishda jamoaviy tadbirlar tashkil qilinadi. Bularning barchasi Sizning dunyo qarashingizni kengaytirish va bilimlaringizni boyitish uchun!",
  },
  {
    id: 10,
    icon: icon10,
    title: "Sertifikat",
    desc: "Aipply Academy kurslarini muvaffaqiyatli tamomlagan barcha o'quvchilarga Sertifikat taqdim etiladi!",
    last: true,
  },
];
...
export const course = [
  ...
  },
  {
    ...
    kurs: "3 oy",
    dars: "Haftada 3 marta 2 soatdan",
    tech: "3DS MAX va AUTOCAD CoronaRender dasturlari hamda ushbu soha bo'yicha sun’iy intellektlar yordamida sifatli 3D-vizualizatsiya va modellashtirish vositalarini batafsil o'rgatish. Kurs davomida loyixalar bilan ishlash, Kurs so’ngida bilimni monetizatsiya qilish o’rgatiladi..",
    slogan:
      "Дизайн интерьера: искусство создавать идеальное пространство. Начните свое путешествие к профессионализму сегодня!",
  },
  {
    id: 9,
    img: motion,
    ...
    kurs: "3 oy",
    dars: "Haftada 3 marta 2 soatdan",
    tech: "Adobe After Effects,  Adobe Premiere Pro, Adobe Audition, Adobe Encoder dasturlari hamda ushbu soha bo'yicha sun’iy intellektlar yordamida sifatli Videomontaj vositalarini batafsil o'rgatish. Kurs davomida loyixalar bilan ishlash, Kurs so’ngida bilimni monetizatsiya qilish o’rgatiladi.",
    slogan:
      "Мир в движении: станьте мастером моушн-дизайна и привнесите динамику в свои проекты!",
  },
];
