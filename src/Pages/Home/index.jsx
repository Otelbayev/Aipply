...
import inoria from "../../assets/images/inoria.png";
import itpark from "../../assets/images/itpark.png";
import selsil from "../../assets/images/selsil.png";
      ...
      <div className="root-container">
        <div className="root-wrapper">
            ...
            <div className="partners">
              <div className="partners__left">
                <div className="partners__left__title">
                  Hamkor va mijozlarimiz jamoasining azosiga aylaning.
                </div>
          ...
          <Mentors ref={mentorRef}>
            <div data-aos="zoom-in" className="title-dark">
