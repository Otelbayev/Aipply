    ...
    <Container className="root-container">
      <div className="root-wrapper">
        ...
        <p>
          ...
          данных составлена в соответствии с требованиями закона от
          «О персональных данных» (далее — Закон о
          ...
          предпринимаемые Aipply academy (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          <b>2.11.</b> Предоставление персональных данных — действия,
        ...
        <p>
          ...
          порядке, установленном действующим законодательством; — отвечать на
        ...
        <p>
          ...
          исключением случаев, предусмотренных законами. Сведения
        ...
        <p>
          ...
          персональных данных не установлен законом, договором,
        ...
        <p>
          ...
          aipply.academy@gmail.com с пометкой «Актуализация персональных
          данных».
        </p>
        <p>
          <b>8.4.</b> Срок обработки персональных данных определяется
          ...
          aipply.academy@gmail.com с пометкой «Отзыв согласия на обработку
          персональных данных».
        </p>
        <p>
        ...
        <p>
          <b>8.8.</b> Оператор осуществляет хранение персональных данных в
          ...
          хранения персональных данных не установлен законом,
        ...
        <p>
          <b>11. </b>Конфиденциальность персональных данных Оператор и иные
        ...
        <p>
          <b>12.2.</b> В данном документе будут отражены любые изменения
          политики обработки персональных данных Оператором. Политика действует
          бессрочно до замены ее новой версией.
        </p>
        <p>
          <b>12.3.</b> Актуальная версия Политики в свободном доступе
